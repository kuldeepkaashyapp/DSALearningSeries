...
1 <= nums[i] <= 10^3
   ...
   /* How Many Numbers Are Smaller Than the Current Number
    ...
    public int[] smallerNumbersThanCurrent(int[] nums) throws Exception{
    ...
    */
    ...
    public int maximumValue(String[] strs) {
        int max=0;
            ...
            // using refence feture of java 8   checking that mathced streame is char or
            // git according to that result saving and turnery oprator will act according to the
            //condition
...
*/
    ...
    private int getWaviness(int i) {
       //exm : 154
        int count = 0;
        // checking waviness approch travels the array and then check each char
